...
const team = [
  {
    id: 1,
    name: "Данила Ситников",
    role: "Руководитель проектов",
    description:
      "Отвечает за управление сложными проектами и выстраивание процессов с заказчиком.",
    photo:
  ...
  },
  {
    ...
    role: "Руководитель проектов",
    description:
      "Фокус на оптимизации бизнес‑процессов и повышении эффективности команды.",
    photo:
  ...
  },
  {
    ...
    description:
      "Отвечает за качество и безопасность технических решений компании.",
    photo:
